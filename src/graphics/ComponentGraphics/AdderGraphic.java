...
public class AdderGraphic extends ComponentGraphic{
    ...
    private static final double BIG_DIAGONAL_LENGTH_X = 80;
    private static final double BIG_DIAGONAL_LENGTH_Y = 30;
    private static final double LITTLE_DIAGONAL_LENGTH_X = 20;
    private static final double LITTLE_DIAGONAL_LENGTH_Y = 5;
    private static final double STRAIGHT_LENGTH = 20;
    ...
    public void updateLoc(double x, double y) {
        ...
        lineDiagonalBottomRight.setStartY(y - (2 * BIG_DIAGONAL_LENGTH_Y));
        lineDiagonalBottomRight.setEndX(x + BIG_DIAGONAL_LENGTH_X);
        lineDiagonalBottomRight.setEndY(y - BIG_DIAGONAL_LENGTH_Y);
        ...
        lineStraightBottom.setEndY(y - (2 * BIG_DIAGONAL_LENGTH_Y));
    }
